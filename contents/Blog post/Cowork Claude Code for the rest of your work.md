...
Key features of Cowork include:
- **Folder Access**: Users can choose which folders Claude can access and work within.
- **Task Automation**: Claude can organize files, create spreadsheets, draft reports, and more, based on user instructions.
- **Connectors and Skills**: Claude can use existing connectors to access external information and new skills to create documents, presentations, and other files.
- **Parallel Tasking**: Users can queue up tasks, allowing Claude to work through them in parallel, making the interaction feel more like leaving messages for a coworker.

Safety and control measures include:
- **User Control**: Users can steer or course-correct Claude's actions.
- **Risk Awareness**: Users should be aware of potential risks such as prompt injections and the possibility of Claude misinterpreting instructions, especially for destructive actions like deleting files.
