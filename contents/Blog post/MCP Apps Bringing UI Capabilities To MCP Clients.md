...
- **Interactive UIs**: Tools can return rich, interactive interfaces instead of plain text.
- **Use Cases**: Data exploration, configuration wizards, document review, and real-time monitoring.
- **Architecture**: Uses tools with UI metadata and UI resources served via the ui:// scheme.
- **Security**: Sandboxed iframes, pre-declared templates, auditable messages, and user consent.
- **Client Support**: Available in Claude, Goose, Visual Studio Code, and ChatGPT.
...
- [MCP Apps SDK](https://www.npmjs.com/package/@modelcontextprotocol/ext-apps) : The official SDK for building MCP Apps, available on npm for easy integration into projects.
- [Goose Tutorials on Building MCP Apps](https://block.github.io/goose/docs/tutorials/building-mcp-apps/) : Tutorials on building MCP Apps using Goose, providing practical examples and step-by-step instructions.
