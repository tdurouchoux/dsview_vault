---
already_read: true
link: https://methodmatters.github.io/true-stories-part-1/
read_priority: 0
relevance: 3
source: Data Elixir
tags:
...
1. **The Graph Was Too Complicated**: A data scientist presented a complex graph to top management, which led to disengagement. The solution is to create simple, clear graphs with explicit takeaways.

2. **The Graph Was Too Simple**: A simple graph led to requests for endless additional data, derailing the project. Solutions include recentering the discussion on high-level topics or considering a change in organization if data is consistently ignored.

3. **When A Graph Leads to Stakeholder Tunnel Vision**: A manager fixated on an irrelevant data point, derailing the meeting. The solution is to recenter the discussion on the main topic.
