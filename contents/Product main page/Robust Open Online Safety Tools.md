...
Key aspects of ROOST include:

- **Child Safety**: Addressing the digital safety gap by providing tools that are often expensive, gate-kept, or challenging to implement.
- **Foundation Model-Powered Content Safeguards**: Collaborating with leading developers to build a community of practice for content safety, identifying and filling critical gaps in training and evaluation datasets.
