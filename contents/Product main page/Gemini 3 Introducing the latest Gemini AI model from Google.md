...
- **Performance**: Gemini 3 Pro outperforms previous models on various benchmarks, including LMArena, Humanity’s Last Exam, and GPQA Diamond.
- **Features**: It offers state-of-the-art reasoning, improved multimodal understanding, and better context interpretation.
- **Applications**: Available across Google products like the Gemini app, AI Studio, Vertex AI, and a new agentic development platform, Google Antigravity.
- **Deep Think Mode**: An enhanced reasoning mode for complex problem-solving, coming soon for Ultra subscribers.
- **Responsible Development**: Underwent comprehensive safety evaluations and partnerships with experts for independent assessments.
...
- [Gemini 3 Pro Model Card](http://deepmind.google/models/model-cards/gemini-3-pro) : This link points to the model card for Gemini 3 Pro, providing detailed information about the model's capabilities, safety evaluations, and performance benchmarks.
