---
already_read: true
link: https://vocabulaires-ouverts.inrae.fr/
read_priority: 0
relevance: 4
source: null
tags:
...
- **Using vocabularies**: Resources for finding and integrating existing vocabularies.
- **Building vocabularies**: Standards, tools, and methodologies for creating new vocabularies.
...
- [Maggot: A Tool for Managing Metadata with Controlled Vocabularies](https://vocabulaires-ouverts.inrae.fr/outil-maggot/) : This link describes **Maggot**, a tool designed to facilitate the creation, management, and sharing of metadata using controlled vocabularies. It is valuable for data scientists looking to implement FAIR principles in their workflows.
- [Using a Vocabulary: Guidelines and Resources](https://vocabulaires-ouverts.inrae.fr/utiliser-vocabulaire/) : This link provides guidance on how to find, integrate, and reuse existing vocabularies in research projects. It is essential for users who want to apply semantic resources in their work.
...
![[topics/Concept/SKOS Simple Knowledge Organization System]]
