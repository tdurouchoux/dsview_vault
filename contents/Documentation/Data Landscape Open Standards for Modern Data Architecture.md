---
already_read: true
link: https://www.data-landscape.com/
read_priority: 0
relevance: 4
source: Data Elixir
tags:
...
Key highlights:
- **Contracts**: OpenAPI, AsyncAPI, GraphQL (Adopt); gRPC (Situational).
- **Storage**: Parquet, Avro (Adopt); Iceberg (Adopt), Delta/Hudi (Situational).
- **Movement**: Kafka, HTTP (Adopt); MQTT/AMQP (Situational).
- **Transformation**: Spark, Pandas, SQL (Adopt); dbt (Adopt).
- **Discovery**: OpenLineage (Adopt); Unity Catalog (Situational).
...
- [CNCF Landscape](https://landscape.cncf.io/) : The CNCF Landscape is an interactive map of cloud-native open-source projects, categorized by their purpose. It served as inspiration for the categorization and visualization approach used in the Data Landscape for organizing open standards in data architecture.
- [Data Landscape GitHub Repository](https://github.com/entropy-data/data-landscape) : The GitHub repository for the Data Landscape project, containing the source code, data (standards.json), and license information. It enables contributions, issue tracking, and collaboration.
