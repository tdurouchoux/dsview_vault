...
Subprojects:
- **Ballista**: Distributed processing extension.
...
- [DataFusion API Documentation (Rust)](https://docs.rs/datafusion/latest/datafusion/) : Comprehensive API documentation for DataFusion, detailing its Rust-based libraries and functionalities for developers.
- [Apache Arrow Official Website](https://arrow.apache.org) : The official website for Apache Arrow, the in-memory format used by DataFusion for columnar data processing.
