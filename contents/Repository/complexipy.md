---
already_read: true
link: https://rohaquinlop.github.io/complexipy/
read_priority: 0
relevance: 4
source: null
tags:
...
**Key Features:**
- **Installation**: Available via pip or uv.
- **Usage**: Can be used via command line or Python API.
- **Configuration**: Supports TOML files for custom settings.
- **Integrations**: Compatible with GitHub Actions, pre-commit hooks, and VS Code.
- **Snapshot Baselines**: Useful for large codebases to track and manage complexity over time.
- **Inline Ignores**: Allows ignoring specific functions with inline comments.

**Technical Details:**
- Measures cognitive complexity, which considers mental effort to understand code.
- Provides actionable insights to improve code quality.
- Supports various output formats (JSON, CSV) and custom thresholds.
- Includes API reference for programmatic use.
